...
public class HideRect : Shape
{
    public HideRect(SvgEditor svgEditor) : base(svgEditor){ }

    internal override Type Presenter => typeof(HideRectEditor);
    public override ShapeType ShapeType => ShapeType.HideRect;
